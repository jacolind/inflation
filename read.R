...
# income 
WDIsearch("income")[c(1,4,12,23,23,26,43), ]
WDIsearch("tax")[c(17,18,19), ]
WDIsearch("tax")[c(23),] #corruption => less faith in gov?
WDIsearch("saving")[c(25, 28, 35, 42, 45), ]
WDIsearch("saved")[c(1,12,34)]
WDIsearch("Bank teller")[c(1,12),] # bank accounts etc
